<div class="modal fade bd-example-modal-lg" id="registroModal" tabindex="-1" role="dialog" aria-labelledby="registroModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form ng-cloack ng-submit="registrarUsuario(datos)" method="post">
                    ...
                    <div class="form-row" style="margin-top:36px;">
                        <div class="col">
                            ...
                            <input type="text" id="tel" class="form-control" placeholder="Numero de Télefono" ng-model="datos.number" pattern="[0-9]{10}" required> 
                        </div>
                        <div class="col">
                            <label for="mail" style="margin-bottom: 18px;">Correo Electrónico</label>
                            <input type="mail" id="mail" class="form-control" placeholder="Correo electrónico" ng-model="datos.mail"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
                        </div>
                        <div class="col">
                            <label for="sexoClient" style="margin-bottom: 13px;">Sexo</label>
                            <select class="form-control" data-style="btn btn-link" id="sexoClient" ng-model="datos.sex" ng-required>
